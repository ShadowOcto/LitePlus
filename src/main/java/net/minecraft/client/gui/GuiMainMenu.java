...
public class GuiMainMenu extends GuiScreen implements GuiYesNoCallback {
    ...
    public void initGui() {
        ...
        this.splashText = "Lite+ Base By ShadowOcto";
    ...
    protected void actionPerformed(GuiButton button) throws IOException {
        ...
        if (button.id == 14) {
            this.mc.displayGuiScreen(Manager.UI.ALT);
        }

        /*if (button.id == 14 && this.altLoginButton.visible)
        {
            this.switchToRealms();
        }*/
...
//        tessellator.draw();
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        this.drawGradientRect(0, 0, this.width, this.height, new Color(0, 0, 0).getRGB(), new Color(52, 152, 252).getRGB());
