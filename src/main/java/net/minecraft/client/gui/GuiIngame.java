...
public class GuiIngame extends Gui
{
    ...
    public void renderGameOverlay(float partialTicks)
    {
        ...
        if (!mc.gameSettings.showDebugInfo) {
            ...
            try {
                Lite.EVENT_BUS.<Event>call(new Render2DEvent(scaledresolution.getScaledWidth(),
                        scaledresolution.getScaledHeight(), partialTicks));
                Lite.EVENT_BUS.<Event>call(new RenderHUDEvent(scaledresolution.getScaledWidth(),
                        scaledresolution.getScaledHeight(), partialTicks));
    ...
    private void renderScoreboard(ScoreObjective p_180475_1_, ScaledResolution p_180475_2_)
    {
        ...
        int k1 = p_180475_2_.getScaledHeight() / 2 + j1 / 3 + (hud.scoreboard ? hud.scoreboardY : 0);
        byte b0 = 3;
