...
public class LayerCape implements LayerRenderer<EntityLivingBase> {
    ...
    private Cape mod = (Cape) Lite.MODULE_FACTORY.findByClass(Cape.class);
    ...
    public String capeSelected = "Lite/capes/Troll.png";
    ...
    public void doRenderLayer(AbstractClientPlayer entitylivingbaseIn, float p_177141_2_, float p_177141_3_, float partialTicks, float p_177141_5_, float p_177141_6_, float p_177141_7_, float scale) {
        if (entitylivingbaseIn.hasPlayerInfo() && !entitylivingbaseIn.isInvisible()) {
            ...
            if (mod == null) {
                mod = (Cape) Lite.MODULE_FACTORY.findByClass(Cape.class);
            }

            switch (mod.mode) {
                case BASIC1: {
                    capeSelected = "Lite/capes/Basic1.png";
                    break;
                }
                case BASIC2: {
                    capeSelected = "Lite/capes/Basic2.png";
                    break;
                }
            }

            if (mod.getData().isEnabled()) {
                this.playerRenderer.bindTexture(new ResourceLocation(capeSelected));
            }
            else {
                this.playerRenderer.bindTexture(new ResourceLocation("Lite/capes/Empty.png"));
            }
